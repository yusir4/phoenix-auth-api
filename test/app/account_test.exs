defmodule MainModule.AccountTest do
  ...
  describe "users" do
    ...
    @valid_attrs %{" name": "some  name", email: "some email", surname: "some surname"}
    @update_attrs %{" name": "some updated  name", email: "some updated email", surname: "some updated surname"}
    @invalid_attrs %{" name": nil, email: nil, surname: nil}
